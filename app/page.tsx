...
const featureRows = [
  {
    eyebrow: "Fast-money product",
    title: "Sellable now",
    body: "VaultKey is the compact entry product: a premium local-AI carry kit for people who want private AI files without buying the full vault first.",
  },
  {
...
const tiers = [
  {
    ...
    price: "$99",
    note: "Founding Sale",
    description: "The obvious purchase: get the fast-money VaultKey product at the first-batch price before the planned regular price.",
    cta: "Buy VaultKey — $99",
    featured: true,
  },
  {
    ...
    description: "Future pricing after the Founding Sale closes. Shown for price anchoring only.",
      ...
      <section className="relative min-h-screen px-5 pb-16 pt-28 sm:px-8 lg:px-10" aria-labelledby="hero-heading">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-10 lg:min-h-[calc(100vh-7rem)] lg:grid-cols-[0.92fr_1.08fr]">
          <div className="max-w-3xl py-10">
            <p className="inline-flex rounded-full border border-white/15 bg-white/8 px-4 py-2 text-xs font-black uppercase tracking-[0.28em] text-zinc-200">Founding Sale · First 100 Units</p>
            <h1 id="hero-heading" className="mt-6 text-5xl font-black leading-[0.88] tracking-[-0.075em] text-white sm:text-7xl lg:text-8xl">
              VaultKey is the fast-money private AI product.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-300 sm:text-xl">
              VaultKey Founding Edition carries your local AI setup so a compatible Mac or Windows computer can run AI locally. No cloud required after setup.
            </p>
      ...
      <section id="founding-sale" className="px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="rounded-[2.5rem] border border-white/12 bg-[linear-gradient(145deg,rgba(255,255,255,0.11),rgba(255,255,255,0.035))] p-8 shadow-[0_30px_100px_rgba(0,0,0,0.45)] lg:p-12">
            ...
            <h2 className="mt-4 text-4xl font-black leading-none tracking-[-0.06em] sm:text-6xl">The $99 offer is the product.</h2>
            <p className="mt-6 text-lg leading-8 text-zinc-300">Founding Edition is built to be the obvious first purchase: premium black/white/silver direction, private local-AI positioning, and a simple $99 entry before the planned $259 regular price.</p>
      ...
      <section id="compare" className="px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-black leading-none tracking-[-0.06em] sm:text-6xl">Founding Edition stays center stage.</h2>
          </div>
      ...
      <section id="faq" className="border-t border-white/10 bg-[#0b0b0b] px-5 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-400">VaultKey turns the OffGrid mission into a fast, affordable first product: help people start building a private AI vault without depending on the cloud after setup.</p>
          </div>
